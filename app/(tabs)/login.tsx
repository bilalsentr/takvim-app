  ...
  return (
    <View style={{flex:1,justifyContent:'center'}}>
      <View style={styles.card}>
        ...
        <TextInput style={styles.input} value={email} onChangeText={setEmail} placeholder='Email Adresiniz'></TextInput>
        <TextInput  style={styles.input} value={password} onChangeText={setPassword} placeholder='Şifreniz' secureTextEntry></TextInput>
